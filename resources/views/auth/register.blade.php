                            ...
                            <form class="user" action="{{ route('register') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <x-input id="name" class="form-control form-control-user" type="text"
                                            name="name" :value="old('name')" placeholder="{{ __('Name') }}" required
                                            autofocus autocomplete="name" />
                                    </div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <x-input id="email" class="form-control form-control-user" type="email"
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <x-input id="username" class="form-control form-control-user"
                                            placeholder="{{ __('Username') }}" type="text" name="username"
                                            :value="old('username')" required />
                                    </div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <x-input id="phone" class="form-control form-control-user"
                                            placeholder="{{ __('Phone Number') }}" type="text" name="phone"
